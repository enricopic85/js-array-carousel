...
//imposto il contatore a 0 per farlo iniziare dal primo elemento dell'array
let currentIndex=0;

const boxTitle=document.getElementById("titolo")
//in questo modo collego la posizione 0 e visualizzo il primo dato contenuto
...
buttonElement.addEventListener('click',function(){
    currentIndex++;
    //per creare il loop infinito
    if (currentIndex >= arrayTitle.length) {
        currentIndex=0;
    }
    boxTitle.innerHTML=arrayTitle[currentIndex];
    boxPar.innerHTML=arrayPar[currentIndex];
